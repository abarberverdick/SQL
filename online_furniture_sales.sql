...
## Show all of the products sold from customers that live in the United States. 

SELECT * FROM sales WHERE country = 'United Sates'; 

## What is the lowest priced furniture sold? 

SELECT product, MIN(price) FROM sales; 

## What is the highest priced furniture sold?

SELECT product, MAX(price) FROM sales; 

## What is the average price of furniture sold and what product is it? 

SELECT product, AVG(price) FROM sales; 

## What two products have we sold more than 10 each of? 

SELECT product FROM sales GROUP BY product HAVING COUNT (*) > 10;

## Were there any transactions that someone paid with a Visa that was the maximum price?  

SELECT * FROM sales WHERE payment_type = 'Visa' AND price = 7500;
