...
## What is the minimum lifetime gross for each movie? 
SELECT title, MIN(Domestic), MIN(Worldwide) FROM topmovies GROUP BY title;

## What is the maximum lifetime gross for each movie? 
SELECT title, MAX(Domestic), MAX(Worldwide) FROM topmovies GROUP BY title;

## What is the average lifetime gross for each movie? 
SELECT title, AVG(Domestic), AVG(Worldwide) FROM topmovies GROUP BY title;
